    ...
    var obj = function () {
        ...
        this.generateBinaryDataFromMask = function () {
            ...
            for(maski = 0; maski < this.mask.length; maski++) {
                ...
                var rgb = [this.imageData.data[img_index*4], this.imageData.data[img_index*4+1], this.imageData.data[img_index*4+2]]
                dist = wpd.colorTools.colorDistance(ref_color, rgb)
